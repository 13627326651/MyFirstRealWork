...
QT_MOC_LITERAL(1, 10, 13), // "readyReadData"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 7), // "qintptr"
QT_MOC_LITERAL(4, 33, 8) // "readData"

    },
    "TcpSocket\0readyReadData\0\0qintptr\0"
    "readData"
};
...
void TcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->readyReadData((*reinterpret_cast< QByteArray(*)>(_a[1])),(*reinterpret_cast< qintptr(*)>(_a[2]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpSocket::readyReadData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TcpSocket::readyReadData(QByteArray _t1, qintptr _t2)
{
